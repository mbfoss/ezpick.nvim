...
local pill               = require("ezpick.base.pill")
...
local _NS_PREFIX         = vim.api.nvim_create_namespace("ezpick_PickerPrefix")
...
---@class ezpick.Picker.ParsedPrompt
---@field query string
---@field flags table
...
---@field parsed ezpick.Picker.ParsedPrompt?
...
---@param query  string
---@param err    ezpick.queryflags.Error
...
---
---@param errors ezpick.queryflags.Error[]? Mistakes in the flags, if any.
---@return {[1]:string,[2]:string?}[]
...
---@return ezpick.queryflags.Error[] errors, ezpick.queryflags.ParseResult parsed
...
function Picker:run_fetch()
	...
	if #self.opts.flags > 0 then
		...
		---@type ezpick.Picker.ParsedPrompt
